...
for data in extract_result :
    #print(data, len(data))
    # & (data[38:78] == "54584f31373330304e3220202020202020202020") 
    if(data[38:78] == "54584f31373330304e3220202020202020202020"):
        for i in range(int(data[90:92])):
            ...
            #md_update_action.append(hex_to_string(data[90+25*i:92+25*i]))
            ...
            #print(hex_to_string(data[38:78]) , data[38:78])
            #print(int(data[78:88]), data[78:88])
            #print(hex_to_string(data[88:90]) , data[88:90])
            #print(int(data[90:92]), data[90:92])
